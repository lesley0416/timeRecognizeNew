...
public class TimeNormalizer implements Serializable {
	...
	public static void main(String args[]) throws Exception {
		...
		String classPath = path.substring(0, path.indexOf("bin/com/time/nlp"));
//		String classPath = "..\\..\\..\\..\\models";
		System.out.println(classPath+"models/TimeExp1.zip");
		TimeNormalizer normalizer = new TimeNormalizer(classPath+"models/TimeExp1.zip");
